            ...
            <section class="row g-3 mt-1" aria-label="Dashboard metrics">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <article class="metric-card metric-warning">
                        ...
                        <div class="metric-value">{{ auth()->user()->count() }}</div>
                        <div class="metric-meta">
                            <span class="text-success">Foydalanuvchilar</span>
                        </div>
                    </article>
                </div>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img class="avatar-img avatar-sm"
                                            src="{{ asset('admin/assets/images/avatar/avatar-1.jpg') }}" alt="Sarah Ahmed">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img class="avatar-img avatar-sm"
                                            src="{{ asset('admin/assets/images/avatar/avatar-3.jpg') }}" alt="Nadia Islam">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img class="avatar-img avatar-sm"
                                            src="{{ asset('admin/assets/images/avatar/avatar-4.jpg') }}" alt="Mina Torres">
                                        <div>
