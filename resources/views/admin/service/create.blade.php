        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section class="row g-3">
                <div class="col-12 col-xl-7">
                    <form class="panel" action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <label for="" class="form-label">Icon (font awesome)</label>
                                <input placeholder="fas fa-phone" value="{{ old('icon') }}" name="icon" type="text" class="form-control @error('icon') is-invalid @enderror">
                                @error('icon')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
