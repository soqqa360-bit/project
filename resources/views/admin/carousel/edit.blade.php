        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section class="row g-3">
                <div class="col-12 col-xl-7">
                    <form class="panel" action="{{ route('carousel.update', $carousel->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input onchange="imgFile(this)" name="image"
                                    class="form-control @error('image') is-invalid @enderror" type="file" id="formName">
                                <div id="previewImage" class="d-none mt-3 img-thumbnail">
                                    <img src="" alt="" id="imgshow" style="max-width: 400px;">
                                </div>

                                <div id="oldImage" class="mt-3 img-thumbnail">
                                    @if ($carousel->image)
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="title" value="{{ $carousel->title }}"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="content" class="form-control @error('content')is-invalid
                                                    @enderror" id="formMessage" rows="5">{{ $carousel->content }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
    ...
    <script>
        function imgFile(input) {
            ...
            if (file) {
                ...
                document.getElementById('oldImage').classList.add('d-none');
            }
        }
    </script>
@endsection